    ...
    <section className={styles.section} aria-labelledby="about-heading">
      <div className={styles.inner}>
        ...
        <p className={styles.text}>
          ...
          technology to improve their lives. We create free, easy-to-read
          guides so everyone can access the programs and tools they deserve.
          Your support keeps these resources free for the people who need them
          most.
        </p>
